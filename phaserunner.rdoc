...
[Default Value] /Users/rberger/.rvm/gems/ruby-2.4.1/gems/asi_bod-0.1.5/BODm.json
...
=== --[no-]no_scale
Do not scale the data from the phaserunner using the scale values from the dict
